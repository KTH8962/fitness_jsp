...
-- 테이블 데이터 fitness.tbl_board:~20 rows (대략적) 내보내기
INSERT INTO `tbl_board` (`BOARDNO`, `USERID`, `TITLE`, `CONTENTS`, `HIT`, `CDATETIME`, `UDATETIME`) VALUES
	...
	(16, 'tea1', '테스트', 'ㅅ', 0, '2024-08-19 14:55:16', '2024-08-21 14:25:17'),
	(17, 'tea2', '안녕안녕', '안녕!', 0, '2024-08-21 11:11:45', '2024-08-21 11:11:45'),
	(18, 'tea4', '용준씨 ', '안녕하세요 용준씨', 0, '2024-08-21 11:57:14', '2024-08-21 11:57:14'),
	(19, 'tea5', '신청해봐요! ', '네네', 0, '2024-08-21 11:58:53', '2024-08-21 14:25:34'),
	(20, 'tea1', '테스트', 'ㅌㅌㅌ', 0, '2024-08-21 15:04:48', '2024-08-21 15:04:59');
...
-- 테이블 데이터 fitness.tbl_class:~20 rows (대략적) 내보내기
INSERT INTO `tbl_class` (`CLASSNO`, `PROGRAMNO`, `ROOMNO`, `CLASS_NUM`, `CLASS_NUM_CNT`, `START_DAY_TIME`, `END_DAY_TIME`, `INSTRUCTOR_ID`, `STATUS`) VALUES
	...
	(5, 101, 201, 5, 1, '2024-09-10 13:00:00', '2024-09-30 17:00:00', 'tea1', 'F'),
	(6, 103, 203, 20, 0, '2024-08-15 08:00:00', '2024-09-22 10:00:00', 'tea3', 'I'),
	(7, 104, 204, 10, 2, '2024-09-14 12:00:00', '2024-10-18 14:00:00', 'tea4', 'F'),
	(8, 101, 201, 6, 1, '2024-08-25 12:00:00', '2024-09-18 14:00:00', 'tea1', 'F'),
	(9, 102, 202, 20, 2, '2024-09-11 09:21:19', '2024-09-14 09:21:27', 'tea2', 'F'),
	...
	(12, 102, 202, 10, 1, '2024-08-22 11:50:00', '2024-08-23 23:50:00', 'tea2', 'F'),
	(13, 103, 203, 10, 1, '2024-08-30 12:30:00', '2024-09-21 12:30:00', 'tea3', 'F'),
	(14, 101, 201, 5, 0, '2024-08-23 09:00:00', '2024-08-31 10:00:00', 'tea1', 'F'),
	(15, 106, 202, 1, 1, '2024-09-15 16:46:00', '2024-10-15 16:46:00', 'tea3', 'F'),
	(16, 102, 202, 2, 2, '2024-09-19 14:55:00', '2024-10-19 14:55:00', 'tea1', 'F'),
	(17, 102, 203, 5, 0, '2024-08-21 11:11:00', '2024-08-31 11:11:00', 'tea2', 'I'),
	(18, 102, 202, 3, 0, '2024-08-22 11:57:00', '2024-08-30 11:57:00', 'tea4', 'F'),
	(19, 105, 203, 4, 1, '2024-08-22 11:59:00', '2024-08-29 11:58:00', 'tea5', 'F'),
	(20, 103, 202, 5, 0, '2024-11-21 15:04:00', '2024-12-24 15:04:00', 'tea1', 'F');
...
-- 테이블 데이터 fitness.tbl_enroll:~12 rows (대략적) 내보내기
INSERT INTO `tbl_enroll` (`ENROLLNO`, `USERID`, `CLASSNO`, `ENROLL_DATE`) VALUES
	(9, 'test', 15, '2024-08-19'),
	(20, 'test3', 16, '2024-08-20'),
	(21, 'dydwns020710', 9, '2024-08-21'),
	(22, 'dydwns020710', 5, '2024-08-21'),
	(23, 'test', 12, '2024-08-21'),
	(24, 'test', 19, '2024-08-21'),
	(25, 'wjseka1234', 8, '2024-08-21'),
	(26, 'test', 16, '2024-08-21'),
	(27, 'test', 13, '2024-08-21'),
	(28, 'tea1', 7, '2024-08-21'),
	(29, 'admin1234', 7, '2024-08-21'),
	(30, 'asdf1234', 9, '2024-08-21');
...
-- 테이블 데이터 fitness.tbl_user:~16 rows (대략적) 내보내기
INSERT INTO `tbl_user` (`USERID`, `PWD`, `PWD_CHANGED`, `NAME`, `BIRTH`, `PHONE`, `EMAIL`, `LOGIN_CNT`, `CREATE_DAY`, `IS_ACTIVE`, `USER_ROLE`, `FIELD`) VALUES
	...
	('admin1234', 'admin123123', '2024-08-21 03:32:39', '1', '2024-08-22', '01012341234', 'test@test.com', 0, '2024-08-21 03:32:39', 1, 'MEMBER', NULL),
	('asdf1234', 'asdf1243', '2024-08-21 03:39:41', 'asdfasdf', '2024-08-12', '01011112222', 'test@test.com', 0, '2024-08-21 03:39:41', 1, 'MEMBER', NULL),
	('asdf5678', 'asdf5678', '2024-08-21 03:42:51', '5678568', '2024-08-04', '01011112222', 'test@test.com', 0, '2024-08-21 03:42:51', 1, 'MEMBER', 'health'),
	('dydwns020710', 'dydwns020710', '2024-08-21 02:44:50', '김용준', '2002-07-10', '01091458604', 'dydwns020710@naver.com', 0, '2024-08-21 02:44:50', 1, 'MEMBER', NULL),
	('hbhyun3102', 'hbhyun3344', '2024-08-21 03:17:09', '황보현', '2024-08-23', '01090152361', 'test@test.com', 0, '2024-08-21 03:17:09', 1, 'MEMBER', NULL),
	...
	('tea3', 'tea3', '2024-08-13 07:58:04', '박요가', '2000-08-15', '01018541234', 'test1@test.com', 0, '2024-08-13 07:58:04', 1, 'TEACHER', 'yoga'),
	('tea4', 'tea4', '2024-08-13 07:58:18', '최필라', '2000-08-15', '01011641234', 'test2@test.com', 0, '2024-08-13 07:58:18', 1, 'TEACHER', 'pilates'),
	('tea5', 'tea5', '2024-08-13 07:58:34', '우복싱', '2000-08-15', '01012771234', 'test3@test.com', 0, '2024-08-13 07:58:34', 1, 'TEACHER', 'boxing'),
	('tea6', 'tea6', '2024-08-13 07:58:53', '강골프', '2000-08-15', '01012348834', 'test4@test.com', 0, '2024-08-13 07:58:53', 1, 'TEACHER', 'golf'),
	('test', 'test', '2024-08-12 02:42:57', '고객일', '1992-07-25', '01012345679', 'member1@example.com', 0, '2024-08-12 02:42:57', 1, 'MEMBER', NULL),
	('test2', 'test2', '2024-08-12 02:42:57', '고객이', '1995-08-30', '5678901234', 'member2@example.com', 0, '2024-08-12 02:42:57', 1, 'MEMBER', NULL),
	('test3', 'test3', '2024-08-20 08:46:55', '김이', '1993-06-24', '01025472155', 'test@test.com', 0, '2024-08-20 08:46:55', 1, 'MEMBER', NULL),
	('wjseka1234', 'wjseka1234', '2024-08-21 03:11:24', 'wjseka', '1993-08-18', '01012341234', 'test1@te1st.com', 0, '2024-08-21 03:11:24', 1, 'MEMBER', 'swimming');
